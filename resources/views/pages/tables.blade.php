                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="text-xs text-secondary mb-0">Banco de dados</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-success">Disponivel</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">Disciplinas Comuns</p>
                                                <p class="text-xs text-secondary mb-0">Geografia</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-secondary">Indisponivel</span>
                                            </td>
                                            <td class="align-middle text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">Informatica</p>
                                                <p class="text-xs text-secondary mb-0">Algoritimos</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-success">Disponivel</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">Informatica</p>
                                                <p class="text-xs text-secondary mb-0">Sistemas Operacionais</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-success">Disponivel</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">Disciplinas comuns</p>
                                                <p class="text-xs text-secondary mb-0">Quimica</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-secondary">Indisponivel</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">Mecanica</p>
                                                <p class="text-xs text-secondary mb-0">Desenho industrial</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-secondary">Indisponivel</span>
                                            </td>
